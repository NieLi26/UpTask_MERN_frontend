...
const ProyectosProvider = ({children}) => {
    ...
    const submitTarea = async tarea => {
        ...
        if ( tarea?.id ) {
            ...
            const { id, ...tareaCreate } = tarea
            await crearTarea(tareaCreate)
        }
    ...
    const agregarColaborador = async email => {
        ...
        try {
            ...
            const { data } = await clienteAxios.post(`/proyectos/colaboradores/${proyecto.
            _id}`, email, config)
    ...
    const eliminarColaborador = async () => {
        try {
            ...
            const { data } = await clienteAxios.post(`/proyectos/eliminar-colaborador/${proyecto.
            _id}`, {id: colaborador._id}, config)
